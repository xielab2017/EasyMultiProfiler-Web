#!/usr/bin/env bash
# V7 one-line installer.
#
#   curl -fsSL https://raw.githubusercontent.com/xielab2017/EasyMultiProfiler-Web/v7.0.0/webapp/scripts/install_from_github.sh | bash
#
# Steps:
#   1. Verify / install git (needed for the clone).
#   2. Clone the repo at the requested branch (default v7.0.0).
