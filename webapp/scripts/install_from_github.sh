#!/usr/bin/env bash
# V8.0.0_Education one-line installer (preview).
#
#   curl -fsSL https://raw.githubusercontent.com/xielab2017/EasyMultiProfiler-Web/V8.0.0_Education/webapp/scripts/install_from_github.sh | bash
#
# Steps:
#   1. Verify / install git (needed for the clone).
#   2. Clone the repo at the requested branch (default V8.0.0_Education).
...
BRANCH="${BRANCH:-${EMP_BRANCH:-V8.0.0_Education}}"
