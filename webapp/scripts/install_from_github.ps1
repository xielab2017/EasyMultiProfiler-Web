# install_from_github.ps1 — V9.0.1_Education one-line installer for Windows (preview).
#
...
#   3. Clones the repo at -Branch (default V9.0.1_Education).
...
param(
  ...
  [string]$Branch    = "V9.0.1_Education"
)
