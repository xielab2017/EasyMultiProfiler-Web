...
const COPY = {
  zh: {
    heroTitle: "EasyMultiProfiler Web v9.0.3 使用指南",
  ...
  en: {
    heroTitle: "EasyMultiProfiler Web v9.0.3 User Guide",
  ...
  return `
    <div class="card guide-hero">
      <div class="guide-hero-head">
        <h2>${L("heroTitle")}</h2>
        <span class="version-badge version-badge-lg">v9.0.3</span>
      </div>
