...
const COPY = {
  zh: {
    heroTitle: "EasyMultiProfiler Web v9.0.5 使用指南",
    ...
    winCardP: "PowerShell 一行命令，或双击 <code>Start-EMP-Panel.bat</code> 点「启动」",
    ...
    winL2: "日常：双击 <code>Start-EMP-Panel.bat</code> →「启动（前端 + 后端）」；或 <code>Start-EMP-Web.bat</code>；桌面按钮：<code>Create-Desktop-Start-Button.bat</code>",
  ...
  en: {
    heroTitle: "EasyMultiProfiler Web v9.0.5 User Guide",
    ...
    macBtn: "Mac steps",
    winCard: "🪟 Windows · Web",
    winCardP: "PowerShell one-liner, or <code>Start-EMP-Panel.bat</code> → Start button",
    ...
    winL2: "Daily: <code>Start-EMP-Panel.bat</code> → Start (frontend + backend); or <code>Start-EMP-Web.bat</code>; desktop: <code>Create-Desktop-Start-Button.bat</code>",
  ...
  return `
    <div class="card guide-hero">
      <div class="guide-hero-head">
        <h2>${L("heroTitle")}</h2>
        <span class="version-badge version-badge-lg">v9.0.5</span>
      </div>
